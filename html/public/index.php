...
<html>
  ...
  <div class="contenedor">
    ...
    <section class="fila">
      <ul>
        <li class="col-4"><a href="patinetes.php"><img src="../img/patinete.png" alt=""></br>
        <label>Patinetes</label></a></li>
        <li class="col-4"><a href="bicicletas.php"><img src="../img/bici.png" alt=""></br>
        <label>Bicicletas</label></a></li>
        <li class="col-4"><a href="ambos.php"><img src="../img/bicipati.png" alt=""></br>
    ...
    <section class="fila">
      ...
      <div class="col-1"></div>
      <ul class="col-5">
        <li cl> <a href="sobre_nosotros.php">¿Quienes Somos?</a></li>
        <li><div>
